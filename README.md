...
- [Tech Torch](fcsitsu.site) → 6-platform university ecosystem: public site, admin panel, student portal, LMS, HR system, and API gateway — fully self-hosted with Docker, Grafana, and Prometheus. *(Next.js, NestJS, PostgreSQL, Redis, Docker)*
